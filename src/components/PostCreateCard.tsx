        ...
        >
          {imageUrls.map((image, index) => (
            <div className="relative flex justify-end" key={index}>
              ...
              <button
                className="absolute top-0 right-0 m-1 p-1 bg-foreground/80 duration-300 text-background rounded-full hover:bg-foreground"
          ...
          <div className="w-full flex flex-row justify-center items-center py-2 gap-2">
            ...
            <p className="opacity-60">
              Select images or drag them here. Only .jpg, .jpeg, .png, and .gif files are supported.
            </p>
          </div>
        </div>
      )}
